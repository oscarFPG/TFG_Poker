...
public final class BotRegistry {
    ...
    public static List<BotDescriptor> getAvailableBots() {
        return List.of(
            new BotDescriptor(GameType.BOT_GEMINI, normalizeBotName("Gemini LLM"), "Gemini Poker LLM", "This bot is powered by Google's Gemini large language model (LLM). It reasons about the game state, evaluates possible actions, and selects moves dynamically instead of following fixed rules.", "/images/bot.png"),
