...
# Nombre del archivo
$modelFile = "llama3-8b-pokerbench-sft-q8_0.gguf"

# Descargar modelo si no existe
if (!(Test-Path $modelFile)) {
    Write-Host "Descargando modelo (~8-5GB, puede tardar)..."

        Invoke-WebRequest `
        -Uri "https://huggingface.co/YiPz/llama3-8b-pokerbench-sft-gguf/resolve/main/llama3-8b-pokerbench-sft-q8_0.gguf" `
        -OutFile $modelFile
}
else {
