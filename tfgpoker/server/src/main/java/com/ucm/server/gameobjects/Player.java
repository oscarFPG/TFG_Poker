...
public abstract class Player implements IPokerPlayer {
    ...
    /**
     * Determines the action that the player will take during their turn.
     * 
     * @param sb     small blind amount
     * @param bb     big blind amount
     * @param maxBet current maximum bet in the round
     * @return {@link String} representing the action taken
     */
    public abstract String actionMakePlay(int sb, int bb, int maxBet);

    /** @param amount amount of the small blind bet */
    public abstract void notifySmallBlindBet(final int amount);

    /** @param amount amount of the big blind bet */
    public abstract void notifyBigBlindBet(final int amount);

    /** Notifies the player that they must wait for their turn */
    public abstract void notifyTurnWait();

    /** Notifies the player that it is their turn to play */
    ...
    /** Notifies that the hand ended due to all players folding */
